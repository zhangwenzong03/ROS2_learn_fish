...
class Metaclass_SpeechText_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('autopatol_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SpeechText(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autopatol_interfaces.srv.SpeechText')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autopatol_interfaces.srv import _speech_text
...
class SpeechText(metaclass=Metaclass_SpeechText):
    from autopatol_interfaces.srv._speech_text import SpeechText_Request as Request
    from autopatol_interfaces.srv._speech_text import SpeechText_Response as Response
