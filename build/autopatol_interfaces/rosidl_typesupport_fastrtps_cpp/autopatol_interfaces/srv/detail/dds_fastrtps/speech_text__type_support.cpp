...
#include "autopatol_interfaces/srv/detail/speech_text__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autopatol_interfaces
cdr_serialize(
  const autopatol_interfaces::srv::SpeechText_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autopatol_interfaces::srv::SpeechText_Request & ros_message)
{
  // Member: text
  cdr >> ros_message.text;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autopatol_interfaces::srv::SpeechText_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autopatol_interfaces::srv::SpeechText_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autopatol_interfaces::srv::SpeechText_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_autopatol_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<autopatol_interfaces::srv::SpeechText_Request>()
{
  return &autopatol_interfaces::srv::typesupport_fastrtps_cpp::_SpeechText_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopatol_interfaces, srv, SpeechText_Request)() {
  return &autopatol_interfaces::srv::typesupport_fastrtps_cpp::_SpeechText_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autopatol_interfaces
cdr_serialize(
  const autopatol_interfaces::srv::SpeechText_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autopatol_interfaces::srv::SpeechText_Response & ros_message)
{
  // Member: result
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autopatol_interfaces::srv::SpeechText_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autopatol_interfaces::srv::SpeechText_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autopatol_interfaces::srv::SpeechText_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &autopatol_interfaces::srv::typesupport_fastrtps_cpp::_SpeechText_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopatol_interfaces, srv, SpeechText_Response)() {
  return &autopatol_interfaces::srv::typesupport_fastrtps_cpp::_SpeechText_Response__handle;
}
...
{
  return &autopatol_interfaces::srv::typesupport_fastrtps_cpp::_SpeechText__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopatol_interfaces, srv, SpeechText)() {
  return &autopatol_interfaces::srv::typesupport_fastrtps_cpp::_SpeechText__handle;
}
