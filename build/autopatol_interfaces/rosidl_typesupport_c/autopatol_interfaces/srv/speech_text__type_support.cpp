...
static const _SpeechText_Request_type_support_symbol_names_t _SpeechText_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatol_interfaces, srv, SpeechText_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopatol_interfaces, srv, SpeechText_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopatol_interfaces, srv, SpeechText_Request)() {
  return &::autopatol_interfaces::srv::rosidl_typesupport_c::SpeechText_Request_message_type_support_handle;
}
...
static const _SpeechText_Response_type_support_symbol_names_t _SpeechText_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatol_interfaces, srv, SpeechText_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopatol_interfaces, srv, SpeechText_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopatol_interfaces, srv, SpeechText_Response)() {
  return &::autopatol_interfaces::srv::rosidl_typesupport_c::SpeechText_Response_message_type_support_handle;
}
...
static const _SpeechText_type_support_symbol_names_t _SpeechText_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatol_interfaces, srv, SpeechText)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopatol_interfaces, srv, SpeechText)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autopatol_interfaces, srv, SpeechText)() {
  return &::autopatol_interfaces::srv::rosidl_typesupport_c::SpeechText_service_type_support_handle;
}
